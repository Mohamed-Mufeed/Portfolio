        ...
        <>
            <div className="outerAbout" id="about">
                <div className="about" >
                    ...
                    <p>Outside of coding, I enjoy solving algorithmic challenges on LeetCode and have maintained long daily streaks as part of my 100 Days of Code journey.</p>
                    <p>My goal is to become a full-stack developer who builds meaningful and accessible digital experiences.</p>
